...
import type { DeepSeekToolCall, DeepSeekUsage, RetryBackoffInfo, StreamCallbacks } from '../types';
...
/** Drive the DeepSeek stream and forward parts to Copilot Chat. */
...
function reportUsage(
	...
	/** DeepSeek reports cache as flat `prompt_cache_hit_tokens`; map into Copilot's shape. */
	const data = {
